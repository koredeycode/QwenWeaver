...
export const mysqlWorkflows = mysqlTable('workflows', {
  id: varchar('id', { length: 36 }).primaryKey(),
  userId: varchar('user_id', { length: 36 }).references(() => mysqlUsers.id, { onDelete: 'cascade' }),
...
export const mysqlNodes = mysqlTable('nodes', {
  id: varchar('id', { length: 128 }).primaryKey(),
  workflowId: varchar('workflow_id', { length: 36 }).references(() => mysqlWorkflows.id, { onDelete: 'cascade' }),
...
export const mysqlEdges = mysqlTable('edges', {
  id: varchar('id', { length: 128 }).primaryKey(),
  workflowId: varchar('workflow_id', { length: 36 }).references(() => mysqlWorkflows.id, { onDelete: 'cascade' }),
...
export const mysqlExecutions = mysqlTable('executions', {
  id: varchar('id', { length: 36 }).primaryKey(),
  workflowId: varchar('workflow_id', { length: 36 }).references(() => mysqlWorkflows.id, { onDelete: 'cascade' }),
  userId: varchar('user_id', { length: 36 }).references(() => mysqlUsers.id, { onDelete: 'cascade' }),
...
export const mysqlAgentLogs = mysqlTable('agent_logs', {
  id: varchar('id', { length: 36 }).primaryKey(),
  executionId: varchar('execution_id', { length: 36 }).references(() => mysqlExecutions.id, { onDelete: 'cascade' }),
...
export const mysqlMcpServers = mysqlTable('mcp_servers', {
  id: varchar('id', { length: 36 }).primaryKey(),
  userId: varchar('user_id', { length: 36 }).references(() => mysqlUsers.id, { onDelete: 'cascade' }),
  name: text('name').notNull(),
  description: text('description'),
...
export const mysqlUserCredits = mysqlTable('user_credits', {
  userId: varchar('user_id', { length: 36 }).primaryKey().references(() => mysqlUsers.id, { onDelete: 'cascade' }),
...
export const mysqlCreditTransactions = mysqlTable('credit_transactions', {
  id: varchar('id', { length: 36 }).primaryKey(),
  userId: varchar('user_id', { length: 36 }).notNull().references(() => mysqlUsers.id, { onDelete: 'cascade' }),
