    ...
    <>
      <section className="relative z-10 overflow-hidden border-b border-outline/40 py-24">
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div
            className="mt-12 rounded-xl border border-primary/30 bg-primary/5 p-8 text-center animate-slide-up"
              ...
              <button
                onClick={() =>
                  navigator.clipboard.writeText(
                    `curl -fsSL https://get.${SITE.name.toLowerCase()}.io | sh`,
                  )
                }
          ...
          <div
            className="mt-12 grid gap-8 lg:grid-cols-3 animate-slide-up"
          ...
          >
            <div className="group rounded-xl border border-outline/40 bg-surface-bright p-8 transition-all hover:border-outline hover:shadow-md">
              <div className="flex items-center justify-between">
                ...
                <span className="rounded bg-primary/20 px-2 py-0.5 text-xs font-mono font-normal text-primary">
                  Default
                </span>
              </div>
              <p className="mt-2 text-sm text-on-surface-variant">
          ...
          <table className="w-full text-left text-sm">
            ...
            <tbody>
              {envVars.map((v) => (
                <tr
                  key={v.key}
                  className="border-b border-outline/20 last:border-0 hover:bg-surface-dim/30 transition-colors"
                >
