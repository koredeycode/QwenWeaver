    ...
    <div className="h-full w-full flex flex-col bg-[#f8fafc] text-slate-800 select-none">
      ...
      <header className="h-14 bg-white border-b border-[#cbd5e1] flex items-center justify-between px-6 z-20">
        ...
        <div className="flex items-center gap-4">
          ...
          {/* Deploy Button (White with blue borders) */}
          <button
            onClick={handleDeploy}
            className="px-3.5 py-1.5 bg-white border border-[#2563eb] text-[#2563eb] font-semibold text-xs flex items-center gap-1.5 rounded-none hover:bg-blue-50 transition-colors"
          >
      ...
      <main className="flex-1 flex overflow-hidden relative">
        ...
        <div className="flex-1 h-full bg-[#f8fafc] relative">
          <ReactFlow
            nodes={nodes}
            edges={edges}
