  ...
  return (
    <div className="h-screen w-screen flex flex-row bg-[#f8fafc] text-slate-800 select-none overflow-hidden">
      ...
      {maximizedNodeId && (() => {
        ...
        const maximizedNodeOutput = useStore.getState().nodeOutputs[maximizedNodeId] || '';
        const maximizedNodeStatus = useStore.getState().nodeStatuses[maximizedNodeId] || 'pending';
      ...
      {isExportOpen && (() => {
        const workflowName = id || 'workflow';
        const exportData = {
          name: workflowName,
          nodes,
          edges
          ...
          >
            ...
            >
              ...
              <div className="p-6 space-y-4">
                {/* Mode selection */}
                <div>
                  <label className="text-[10px] font-mono font-bold text-slate-400 uppercase tracking-wider block mb-2">Import Strategy</label>
                ...
                {/* Text area paste */}
                <div className="space-y-1">
                  <label className="text-[10px] font-mono font-bold text-slate-400 uppercase tracking-wider block">Method 2: Paste Raw JSON</label>
                  <textarea
