...
export const EXAMPLE_WORKFLOWS: ExampleWorkflow[] = [
  ...
  },
  {
    ...
    edges: [
      { id: 'e-ti-tr', source: 'node-trigger-input', target: 'node-translator', sourceHandle: 'source', targetHandle: 'target-left', type: 'animated' },
      { id: 'e-tr-rev', source: 'node-translator', target: 'node-reviewer', sourceHandle: 'source-right', targetHandle: 'target-left', type: 'animated' },
      { id: 'e-rev-save', source: 'node-reviewer', target: 'node-mcp-saver', sourceHandle: 'source-bottom', targetHandle: 'target', type: 'animated' },
    ],
  },
  {
    id: 'security-audit',
